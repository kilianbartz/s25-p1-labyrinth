...
//     version 1.14.0
//     from Assets/Scripts/Player/CharacterInput 1.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Player/CharacterInput 1.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CharacterInput1: IInputActionCollection2, IDisposable
{
    ...
    ~@CharacterInput1()
    {
        UnityEngine.Debug.Assert(!m_Character.enabled, "This will cause a leak and performance issues, CharacterInput1.Character.Disable() has not been called.");
    }
