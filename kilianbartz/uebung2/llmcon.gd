class_name llmcon extends HTTPRequest

var options = {}
var url = "https://openrouter.ai/api/v1/chat/completions"
var model = "google/gemini-2.5-flash-lite-preview-06-17"
var chat_messages = [] 
@onready var npc: npc = $".."
...
func make_message(description: String):
	return {"role": 'user', "content": """Du bist ein entspannter NPC namens Remy in einem Videospiel und kommst aus Hessen. Du kannst eine der folgenden Aktionen auswählen: 
		%s. 
		%s.
		...
		Bei FIGHT_PLAYER sollte content eine Liste von 10 Aktionen sein, die nacheinander ausgeführt werden. Zur Verfügung stehen hier ATTACK, BLOCK und COUNTER.
		Wenn du bereits im Kampf bist, bleibe im Kampf.""" % [available_actions, description]}
